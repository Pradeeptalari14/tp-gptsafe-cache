# 🔧 Troubleshooting Guide — GPTSafe (Semantic Cache)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-gptsafe-cache/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/gptsafe-cache/)

...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/gptsafe-cache/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-gptsafe-cache.git
cd tp-gptsafe-cache
```
...
```bash
kubectl port-forward deployment/tp-gptsafe-cache 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
---
*Generated by [GPTSafe (Semantic Cache) Studio](https://pradeeptalari14.github.io/portfolio/tools/gptsafe-cache/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
